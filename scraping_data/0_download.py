...
print("--- Skrip Modifikasi untuk Scraping 5000 Data ---")

# 1. Tentukan jumlah data
# 1. UBAH JUMLAH DATA
JUMLAH_TRAIN = 4500  # Naikkan jadi 4500
JUMLAH_DEV = 250
JUMLAH_TEST = 250
...
try:
    ...
    # Sebelum: 'data/raw/dev' -> Sekarang: 'data_5000/raw/dev'
    thread_func(urls_dev_kecil, 'data_5000/raw/dev', THREAD) 
    
    print(f"\nMemproses {JUMLAH_TEST} data 'test'...")
    # Sebelum: 'data/raw/test' -> Sekarang: 'data_5000/raw/test'
    thread_func(urls_test_kecil, 'data_5000/raw/test', THREAD)
    
    print(f"\nMemproses {JUMLAH_TRAIN} data 'train'...")
    # Sebelum: 'data/raw/train' -> Sekarang: 'data_5000/raw/train'
    thread_func(urls_train_kecil, 'data_5000/raw/train', THREAD)
